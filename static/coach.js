(() => {
  ...
  const HIGHLIGHT_ROWS = [
    ...
    { key: "aerial_goals",  label: "Goles aéreos", suffix: "", direction: "high_good" },
    { key: "bicycle_goals", label: "Chilenas",     suffix: "", direction: "high_good" },
    { key: "long_goals",    label: "Goles largos", suffix: "", direction: "high_good" },
    { key: "centers",       label: "Centros",      suffix: "", direction: "high_good" },
